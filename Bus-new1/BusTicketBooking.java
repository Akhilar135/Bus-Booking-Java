...
public void userDetails() {
    ...
    public void getBus() {
        ...
        busList.add(new Bus("Mumbai Travels",2500,1));
        busList.add(new Bus("Banglore Travels",2700,2));
        busList.add(new Bus("Chennai Travels",3000,3));

        System.out.println("----------***----------");
        System.out.println("-------Available Buses------");
        Stream<Bus> stream = busList.stream();
        stream.forEach((t)->System.out.println(t));
       
        // Stream<Bus> sortStream = busList.stream().sorted();
        // sortStream.forEach((t1)->System.out.println(t1));
    ...
    public void busDetails()  {
        ...
        System.out.println("invalid ");
         ...
         busChoicePrice=busList.get(busNum-1).price;
            ...
            System.out.println("Bus not available....Enter valid bus number "+e);
...
public class BusTicketBooking {
    ...
    // public BusTicketBooking(Journey journey) {
    // }
